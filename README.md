...
# 上图所示的卷积层包含参数数量为：
# num(w) + num(b) = (in_channels * out_channels * kernel_size^2) + out_channels = 3 * 2 * 3^2 + 2 = 56。
```
...
<p align="center"><img width="100%" src="pics/unpooling_deconv.png" /></p>
...
<p align="center"><img width="50%" src="pics/BN-equation.png" /></p>
...
<p align="left"><img width="15%" src="pics/LReLU-equation.png" /></p>
...
<p align="left"><img width="20%" src="pics/softmax.png" /></p>
...
<p align="left"><img width="30%" src="pics/softmaxwithloss.png" /></p>
